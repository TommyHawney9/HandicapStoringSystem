...
class Confirm2 {
    ...
    Confirm2(String title, int width, int height, int totalAdScore, int totalPar, int totalScore, Golfer golfer) {
        this.title = title;
        this.width = width;
        this.height = height;
    ...
    private void createDisplay() {
        ...
        confirm.addActionListener(e ->  {
            golfer.setAdScores2(totalAdScore);
            golfer.setPar2(totalPar);
            golfer.setHandicap();
            //new SignUp
            new SignUp("Handicap Helper", 210, 350, golfer);
            frame.dispose();
