...
class Scorecard1 extends JFrame{
    ...
    private JLabel hole1 = new JLabel("1");
    private JLabel hole2 = new JLabel("2");
    private JLabel hole3 = new JLabel("3");
    private JLabel hole4 = new JLabel("4");
    private JLabel hole5 = new JLabel("5");
    private JLabel hole6 = new JLabel("6");
    private JLabel hole7 = new JLabel("7");
    private JLabel hole8 = new JLabel("8");
    private JLabel hole9 = new JLabel("9");
    ...
    Scorecard1(String title, int width, int height, Golfer golfer){
        this.title = title;
        this.width = width;
        this.height = height;
        this.golfer = golfer;
        ...
        cont.addActionListener(e ->  {
            ...
            if(!error) {
                ...
                if (pars[0].getText().isEmpty()) {
                    ...
                    new Confirm("Handicap Helper", 210, 350, totalAdScore, totalPar, totalScore, golfer);
                    frame.dispose();
            }
        });
        panel.add(cancel);
